...
<body>
    <header class="bg-gray-900 fixed top-0 left-0 right-0">
        <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center py-3 px-6 lg:px-6">
            <div class="flex lg:flex-1">
                <a href="/" class="-m-4 p-2 ml-1">
                    <img src="/images/kashpluh.logo.svg" class="h-15 w-auto">
                </a>
            </div>

            <div class="p-2">
                <h1 class="text-white">Kashpluh</h1>
            </div>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                ...
                <?php else: ?>
                    <a href="/register" class="text-sm/6 font-semibold text-white">Register</a>
                <?php endif ?>
            </div>
        </nav>
        <el-dialog>
